...
VALUES 
('user1@example.com', 'password1', 'Nguyen Van A', 25, 'avatar1.png'),
('user2@example.com', 'password2', 'Tran Thi B', 30, 'avatar2.png'),
('user3@example.com', 'password3', 'Le Van C', 28, 'avatar3.png'),
('user4@example.com', 'password4', 'Pham Van D', 35, 'avatar4.png'),
('user5@example.com', 'password5', 'Hoang Thi E', 22, 'avatar5.png'),
('user6@example.com', 'password6', 'Dang Van F', 27, 'avatar6.png'),
('user7@example.com', 'password7', 'Nguyen Thi G', 29, 'avatar7.png'),
('user8@example.com', 'password8', 'Le Van H', 31, 'avatar8.png'),
('user9@example.com', 'password9', 'Pham Thi I', 26, 'avatar9.png'),
('user10@example.com', 'password10', 'Tran Van J', 34, 'avatar10.png');
